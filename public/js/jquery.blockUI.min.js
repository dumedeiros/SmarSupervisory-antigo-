...
(function() {
    ...
    function e(e) {
        ...
        function h(t) {
            if (t.keyCode && t.keyCode == 9 && o && t.data.constrainTabKey) {
            ...
            a.hasClass("blockOverlay") && s.onOverlayClick && s.onOverlayClick();
